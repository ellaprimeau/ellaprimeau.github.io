...
gtfsUrl = 'https://transitfeeds.com/p/oc-transpo/30/20200203/download'
db = 'oc_old'
faunaKey = ''

r = requests.get(gtfsUrl)
# print(faunaKey)
...
os.system("fauna schema push --active --no-input --dir api/ --secret {}:{}:admin".format(faunaKey, db))
os.system("cd api/gtfs & fauna import --path . --secret {}:{}:admin".format(faunaKey, db))
